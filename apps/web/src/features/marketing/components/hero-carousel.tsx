...
const SLIDE_LABEL_CLASS = cn(
  ...
  "absolute bottom-14 left-7 sm:bottom-7 flex items-center gap-3 text-faint md:left-14",
);
...
export function HeroCarousel({ carousel, pulse }: HeroCarouselProps) {
  ...
  return (
    <div
      ...
      className="atlas4-panel relative min-h-140 md:h-[74vh] w-full max-w-280 overflow-hidden rounded-[22px]"
    >
      <div
      ...
      <div className="relative grid min-h-140 grid-cols-1 md:absolute md:inset-0 md:min-h-0 items-center gap-x-13.5 gap-y-8 px-5 pb-24 pt-8 sm:px-7 md:gap-y-0 md:pb-21 md:grid-cols-2 md:px-14 md:pt-16.5">
        ...
        <div key={`visual-${tick}`} className="atlas4-reveal flex min-w-0 items-center md:h-full">

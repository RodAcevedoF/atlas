...
const CATEGORY_ALIASES: Array<{
  ...
  { category: "politics", aliases: ["politics", "political", "elections", "world", "geopolitics"] },
  { category: "crypto", aliases: ["crypto", "cryptocurrency"] },
  { category: "sports", aliases: ["sports"] },
  {
    category: "economics",
    aliases: ["economics", "economy", "financials", "finance", "companies", "commodities"],
  },
  {
    category: "science",
    aliases: ["science", "technology", "science and technology", "climate and weather", "health"],
  },
  { category: "culture", aliases: ["entertainment", "culture", "pop culture"] },
];
